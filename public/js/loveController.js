/*
  ...
  This code allows you to "love" posts using unique ID's and such.
  It's a pain in the ass, and personally, I hate it (with a passion).
*/

function lovePost(postId) {
    // Make a POST request to the love API endpoint
    fetch(`/api/v2/love/${postId}`, {
      method: 'POST',
      headers: {
